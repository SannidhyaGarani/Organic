              ...
              {items.map((item) => (
                ...
                >
                  <div className="w-32 h-32 rounded-2xl overflow-hidden bg-[#F7F6F2] border border-[#6E8B3D]/20 flex-shrink-0">
                    <img src={item.images?.[0] || item.image} alt={item.title || item.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </div>

    ...
    <div className="min-h-screen bg-[#F7F6F2] pt-32 pb-24 px-6">
      <div className="max-w-[1300px] mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[3rem] p-10 md:p-20 shadow-sm border border-[#1E3D2B]/5 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="text-lg text-[#6B4F3F] leading-relaxed opacity-70">
              Whether you're seeking guidance on your wellness journey or have a question about our farm-to-bottle process, our concierge team is here to assist.
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-[#1E3D2B] rounded-[3rem] p-10 text-white relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-10">
                {[
                  { icon: Mail, label: "Correspondence", val: "care@Leaforganics.com" },
                  { icon: Phone, label: "Direct Line", val: "+1 (888) Leaf-ORG" },
                  { icon: MessageCircle, label: "WhatsApp", val: "Chat with Us" }
                ].map((item, i) => (
                  <div key={i} className="group cursor-pointer">
                    <p className="text-[9px] font-black uppercase tracking-widest text-white/40 mb-2">{item.label}</p>
                    <div className="flex items-center justify-between">
                      <p className="text-xl font-medium tracking-tight group-hover:text-[#6E8B3D] transition-colors">{item.val}</p>
                      <item.icon size={18} className="text-[#6E8B3D] opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0" />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-16 pt-8 border-t border-white/10 flex items-center justify-between">
                <div>
                  <p className="text-[9px] font-black uppercase tracking-widest text-white/40">Studio Hours</p>
                  <p className="text-sm font-medium mt-1">Mon—Fri, 9am—6pm</p>
                </div>
            ...
            {/* Location Card */}
            <div className="bg-white rounded-[2.5rem] p-8 border border-[#1E3D2B]/5 flex items-center gap-6 group hover:border-[#6E8B3D]/30 transition-all duration-500">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-[#1E3D2B]">Mumbai, Maharashtra</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-[3rem] p-10 md:p-16 border border-[#1E3D2B]/5 shadow-sm relative">
              <div className="mb-12">
                ...
                <p className="text-sm text-[#6B4F3F] mt-2 opacity-60">Fields marked with an asterisk are required.</p>
              </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-6">
                  ...
                  <button className="group relative bg-[#6E8B3D] hover:bg-[#1E3D2B] text-white px-12 py-5 rounded-2xl transition-all duration-500 overflow-hidden shadow-xl shadow-[#6E8B3D]/20">
                    <div className="relative z-10 flex items-center gap-3">
                      <span className="text-[11px] font-black uppercase tracking-widest">Send Inquiry</span>
        ...
        <div className="bg-[#E5E3DB]/30 rounded-[2.5rem] p-10 flex flex-wrap justify-center items-center gap-x-20 gap-y-6">
           <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#1E3D2B]/30 w-full text-center lg:w-auto">As Featured In</p>
           {['VOGUE', 'ELLE', 'BAZAAR', 'VANITY FAIR'].map((brand) => (

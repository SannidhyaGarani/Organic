        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 min-h-[600px]">
          ...
          <div className="lg:col-span-7 p-8 md:p-16 lg:p-24 flex flex-col justify-center space-y-10 relative z-30">
            <div className="space-y-4">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-light text-[#FDFCFB] leading-[1.1] tracking-tight">
                Pure <span className="italic font-serif text-[#A3B882]">Vitality</span> <br />
                <span className="opacity-90">Redefined.</span>
              </h2>
            </div>

            <p className="max-w-md text-[#FDFCFB]/70 text-lg font-light leading-relaxed">
              Experience the pinnacle of organic potency. Hand-harvested, 
              cold-pressed, and delivered to your sanctuary within 24 hours.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 pt-4">
              <button className="group relative flex items-center gap-12 bg-[#FDFCFB] text-[#15291E] pl-8 pr-4 py-4 rounded-full transition-all duration-500 hover:pr-8 hover:bg-[#A3B882] hover:text-white">
                <span className="text-xs font-bold uppercase tracking-widest">Begin Your Ritual</span>
              ...
              <div className="flex flex-col gap-1 border-l border-white/10 pl-6">
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#8B9D77]">First Order</span>
          ...
          <div className="lg:col-span-5 relative h-[450px] lg:h-auto overflow-hidden bg-[#1E3326]">
            ...
            >
              <div className="w-40 h-40 rounded-full border border-white/20 backdrop-blur-xl bg-black/10 flex flex-col items-center justify-center text-center p-4">
                <ShieldCheck size={20} className="text-[#A3B882] mb-2" />
                <span className="text-white text-[10px] font-bold uppercase tracking-[0.3em] leading-tight">
                  Certified <br /> Organic
                </span>
                <div className="mt-2 w-8 h-[1px] bg-white/30" />
                <span className="mt-2 text-[8px] text-white/50 uppercase tracking-widest font-medium">Est. 2024</span>
              </div>
            </div>

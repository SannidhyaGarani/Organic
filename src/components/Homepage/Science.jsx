...
import { Microscope, Shield, Zap, Beaker, ArrowRight, Dna } from 'lucide-react';
...
const ScienceSection = () => {
  const features = [
    { 
      ...
      desc: 'Cold-pressed processing ensures 98% nutrient retention.',
      tag: 'Bio-Static'
    },
    { 
      icon: Shield, 
      title: 'Bio-Availability', 
      desc: 'Formulated for maximum cellular absorption and rapid effect.',
      tag: 'High-Absorb'
    },
    { 
      icon: Zap, 
      title: 'Potency Tested', 
      desc: 'Every batch is verified for active alkaloid concentration.',
      tag: 'Lab-Grade'
    }
  ];
            ...
            <div className="relative p-6 md:p-12 lg:p-16 flex items-center justify-center">
              <div className="relative w-full aspect-[4/5] lg:aspect-square">
                ...
                <div className="absolute top-10 -right-8 backdrop-blur-xl bg-white/10 border border-white/20 p-5 rounded-3xl shadow-2xl animate-pulse">
                  <Dna className="text-[#6E8B3D] mb-2" size={24} />
                ...
                <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-[90%] backdrop-blur-2xl bg-white/90 p-8 rounded-[2rem] shadow-2xl flex items-center justify-between border border-white/50">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-[#1E3D2B]/40">Batch Purity</p>
                      <p className="text-xl font-bold text-[#1E3D2B]">99.8% Certified</p>
                    </div>
                  </div>
                  <div className="hidden sm:block text-right">
                    <div className="flex gap-1 justify-end mb-1">
                      {[1,2,3].map(i => <div key={i} className="w-1 h-3 bg-[#6E8B3D] rounded-full" />)}
                    </div>
                    <p className="text-[9px] font-black text-[#1E3D2B] opacity-40 uppercase">Grade A</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-5xl md:text-7xl font-light text-[#F7F6F2] leading-[0.95] tracking-tighter">
                    Ayurveda <br />
                    <span className="font-serif italic text-[#6E8B3D]">Engineering.</span>
                  </h2>
                  <p className="text-white/50 text-base leading-relaxed max-w-md font-medium">
                    We transcend basic extraction. Using proprietary cold-chain protocols, we isolate the essence of the plant without thermal degradation.
                  </p>
                </div>
                ...
                <div className="pt-6">
                  <button className="group relative px-12 py-5 rounded-full bg-white text-[#1E3D2B] font-bold text-xs uppercase tracking-[0.2em] overflow-hidden transition-all hover:bg-[#6E8B3D] hover:text-white">
                    <span className="relative z-10 flex items-center gap-3">
                      View Lab Analysis <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                    </span>
                  </button>
                </div>
              </div>

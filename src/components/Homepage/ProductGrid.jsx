...
import { Plus, Heart, Eye, Loader2, Star, Sparkles, ShoppingBag } from 'lucide-react';
        ...
        <div>
          <h3 className="text-xl font-light text-[#1E3D2B] leading-none tracking-tighter mb-1">
            ...
            {(() => {
              ...
              return rest ? <span className="font-black italic">{rest}</span> : null;
            })()}
          </h3>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-10 border-b border-[#1E3D2B]/5 pb-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#6E8B3D]">Handpicked Harvests</span>
            </div>
            <h2 className="text-6xl md:text-8xl font-light text-[#1E3D2B] leading-[0.85] tracking-tighter">
              The <span className="font-black italic">Collection</span>
            </h2>
          </div>

          <div className="flex flex-col items-start md:items-end gap-6">
            <div className="flex p-1.5 bg-white rounded-2xl border border-[#1E3D2B]/5 shadow-sm overflow-x-auto max-w-full">
              {['All', 'Powders', 'Superfoods', 'Blends'].map((cat) => (
                <button
                  key={cat}

...
import { Send, Sparkles, ShieldCheck, Mail, ArrowRight, Leaf } from 'lucide-react';
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        <div className={`grid lg:grid-cols-12 gap-12 items-center transition-all duration-[1.5s] ${
          ...
          <div className="lg:col-span-6 space-y-8 text-center lg:text-left">
            ...
            <h2 className="text-6xl md:text-8xl font-serif text-[#1E3D2B] leading-[0.85] tracking-tighter">
              A Living <br />
            ...
            <p className="text-lg text-[#6B4F3F]/80 font-light leading-relaxed max-w-md mx-auto lg:mx-0">
              Receive our seasonal field notes, <span className="text-[#1E3D2B] font-medium">exclusive harvest alerts</span>, and the science of organic longevity. No noise, just nature.
            </p>

            <div className="flex flex-wrap justify-center lg:justify-start gap-6 pt-4">
               <div className="flex items-center gap-2 opacity-60">
                  <ShieldCheck size={16} className="text-[#6E8B3D]" />
                  <span className="text-[9px] font-bold uppercase tracking-widest text-[#1E3D2B]">Secure</span>
               </div>
               <div className="flex items-center gap-2 opacity-60">
                  <Sparkles size={16} className="text-[#6E8B3D]" />
                  <span className="text-[9px] font-bold uppercase tracking-widest text-[#1E3D2B]">Curated</span>
               </div>
            </div>
          </div>
            ...
            <div className="relative bg-[#1E3D2B] rounded-[2.5rem] p-8 md:p-14 shadow-2xl overflow-hidden border border-white/5">
              ...
              <form onSubmit={handleSubmit} className="relative z-10 space-y-10">
                <div className="space-y-2">
                  <h3 className="text-white font-serif text-2xl italic">Subscribe to the ritual</h3>
